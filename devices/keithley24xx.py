...
class keithley_24xx(SMUBase):
    ...
    def set_voltage_range_value(self, voltage_range):
        """
        Set voltage range value for Keithley 24xx
        ...
        if voltage_range == 0:
            ...
            # The Keithley 24xx will automatically select the closest available range
    ...
    def set_source_current_range_value(self, current_range):
        """
        Set current range value for Keithley 24xx
...
# Test code for Keithley 24xx
if __name__ == '__main__':
    import time
    visaResourceName = 'GPIB0::26::INSTR'  # Adjust for your instrument
    
    def test_keithley_24xx():
        """Test basic connection and identification"""
        current_smu = keithley_24xx()
    ...
    def test_source_function():
        """
        Test source function functionality for Keithley 24xx
        ...
        """
        print("Testing Keithley 24xx Source Function Functionality")
        print("=" * 55)
    ...
    def test_voltage_range():
        """
        Test voltage range functionality for Keithley 24xx
        ...
        """
        print("Testing Keithley 24xx Voltage Range Functionality")
        print("=" * 50)
    ...
    def test_source_delay():
        """
        Test source delay functionality for Keithley 24xx
        ...
        """
        print("Testing Keithley 24xx Source Delay Functionality")
        print("=" * 50)
    ...
    def test_measurement_functions():
        """
        Test measurement functionality for Keithley 24xx
        ...
        4. Setting limits
        """
        print("Testing Keithley 24xx Measurement Functionality")
        print("=" * 55)
