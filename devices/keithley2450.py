...
class keithley_2450(SMUBase):
    ...
    def set_front_terminal(self):
        """
        Set terminal to front
        
        According to Series 2400 SourceMeter User's Manual:
        - Sets the output terminal to front panel
        - Uses SCPI command: :ROUT:TERM FRON
        """
        self.Keithley.write(':ROUT:TERM FRON')
    '''tested'''
    def set_rear_terminal(self):
        """
        Set terminal to rear
        
        According to Series 2400 SourceMeter User's Manual:
        - Sets the output terminal to rear panel
        - Uses SCPI command: :ROUT:TERM REAR
        """
    ...
    def get_source_voltage_delay_time(self):
        ...
        """
        return float(self.Keithley.query(":SOUR:VOLT:DEL?"))
    ...
    def get_source_voltage_delay_auto_status(self):
        ...
        """
        return self.Keithley.query(":SOUR:VOLT:DEL:AUTO?").strip()
    ...
    def get_source_function(self):
        ...
        """
        return self.Keithley.query(':SOUR:FUNC?').strip()
    ...
    def set_voltage_range_value(self, voltage_range):
        """
        Set voltage range value for Keithley 2450
        ...
        if voltage_range == 0:
            ...
            # The Keithley 2450 will automatically select the closest available range
    ...
    def get_voltage_range(self):
        ...
        """
        return float(self.Keithley.query(":SOUR:VOLT:RANG?"))
    ...
    def get_voltage_autorange_status(self):
        ...
        """
        return self.Keithley.query(":SOUR:VOLT:RANG:AUTO?").strip()
    ...
    def set_source_current_range_value(self, current_range):
        """
        Set current range value for Keithley 2450
        ...
        if current_range == 0:
            ...
            # The Keithley 2450 will automatically select the closest available range
            self.Keithley.write(f":SOUR:CURR:RANG {current_range}")
    ...
    def get_source_current_range(self):
        ...
        """
        return float(self.Keithley.query(":SOUR:CURR:RANG?"))
    ...
    def get_source_current_autorange_status(self):
        ...
        Returns:
            str: Auto-range status (ON/OFF)
        """
        return self.Keithley.query(":SOUR:CURR:RANG:AUTO?").strip()
    ...
    def set_source_current_level(self, current_level):
        ...
        """
        self.Keithley.write(f":SOUR:CURR:LEV {current_level}")
    ...
    def get_source_voltage_level(self):
        ...
        """
        return float(self.Keithley.query(":SOUR:VOLT:LEV?"))
    ...
    def get_source_current_level(self):
        ...
        """
        return float(self.Keithley.query(":SOUR:CURR:LEV?"))
    ...
    def get_measure_function(self):
        ...
        """
        return self.Keithley.query(":SENS:FUNC?").strip()
    ...
    def set_measure_voltage_range(self, voltage_range):
        ...
        """
        self.Keithley.write(f":SENS:VOLT:RANG {voltage_range}")
    ...
    def set_measure_voltage_limit(self, voltage_limit):
        ...
        """
        self.Keithley.write(f":SOUR:CURR:VLIM {voltage_limit}")
    ...
    def set_measure_voltage_nplc(self, nplc_value):
        ...
        Args:
            nplc_value (float): Number of power line cycles
        """
        self.Keithley.write(f":SENS:VOLT:NPLC {nplc_value}")
...
# Test code for Keithley 2450
if __name__ == '__main__':
    import time
    visaResourceName = 'GPIB0::27::INSTR'  # Adjust for your instrument
    
    def test_keithley_2450():
        """Test basic connection and identification"""
        current_smu = keithley_2450()
    ...
    def test_source_function():
        """
        Test source function functionality for Keithley 2450
        ...
        """
        print("Testing Keithley 2450 Source Function Functionality")
        print("=" * 55)
    ...
    def test_voltage_range():
        """
        Test voltage range functionality for Keithley 2450
        ...
        """
        print("Testing Keithley 2450 Voltage Range Functionality")
        print("=" * 50)
    ...
    def test_source_delay():
        """
        Test source delay functionality for Keithley 2450
        ...
        """
        print("Testing Keithley 2450 Source Delay Functionality")
        print("=" * 50)
    ...
    def test_measurement_functions():
        """
        Test measurement functionality for Keithley 2450
        ...
        4. Setting limits
        """
        print("Testing Keithley 2450 Measurement Functionality")
        print("=" * 55)
    ...
    def test_output_control():
        """
        Test output control functionality for Keithley 2450
        ...
        """
        print("Testing Keithley 2450 Output Control Functionality")
        print("=" * 55)
